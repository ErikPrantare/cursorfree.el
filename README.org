...
** Setup
First, install the dependencies [[https://github.com/ErikPrantare/hatty.el][hatty.el]], [[https://github.com/magnars/multiple-cursors.el][multiple-cursors.el]] and
...
#+begin_src elisp
  ...
  (phony-define-dictionary my/shapes
