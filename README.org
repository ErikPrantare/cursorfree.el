...
This package provides a simple command language well suited for voice
control of Emacs.  This allows you to modify text, jump around in the
buffer and follow links by referring to the target of your action
immediately.
...
** Setup
First, install the required dependency [[https://github.com/magnars/multiple-cursors.el][multiple-cursors.el]].  If you
are using this with voice control, also install [[https://github.com/ErikPrantare/phony.el][phony.el]].

We also recommend installing [[https://github.com/ErikPrantare/hatty.el][hatty.el]] to allow querying arbitrary
positions in the visible text.
