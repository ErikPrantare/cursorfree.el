...
- Modifiers:
  ...
  - New modifier "end": Return a target referring to the last position
    of the buffer.  Useful in conjunction with "past", e.g. "end past
    chuck" removes everything from point until the end of the buffer.
    "end" takes an optional buffer or window as argument, to pick the
    end of the buffer in that buffer or window.
